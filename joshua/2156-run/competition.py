...
class MLP(nn.Module):
  def __init__(self):
    super().__init__()
    self.fc1 = nn.Linear(539, 2156)
    self.norm1 = nn.BatchNorm1d(2156)
    self.act1 = nn.ReLU()
    self.fc2 = nn.Linear(2156, 2156)
    self.norm2 = nn.BatchNorm1d(2156)
    self.act2 = nn.ReLU()
    self.fc3 = nn.Linear(2156, 2156)
    self.norm3 = nn.BatchNorm1d(2156)
    self.act3 = nn.ReLU()
    self.fc4 = nn.Linear(2156, 2156)
    self.norm4 = nn.BatchNorm1d(2156)
    self.act4 = nn.ReLU()
    self.fc5 = nn.Linear(2156, 1)
  def forward(self, x):
...
#    x = (self.act8(self.norm8(self.fc8(x))))
#    x = (self.act9(self.norm9(self.fc9(x))))
#    x = self.fc10(x)
    return x
